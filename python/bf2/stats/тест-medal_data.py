...
medal_data = (	
		#Badges
			...
			('121_1', 'veb', LIMIT_SINGLE, f_plus(	f_plus(	object_stat ('vehicles', 'rtime', VEHICLE_TYPE_as_hov_light),
									object_stat ('vehicles', 'rtime', VEHICLE_TYPE_heavy_ifv),
									object_stat ('vehicles', 'rtime', VEHICLE_TYPE_TRANSP_AIR), 600), 20),

			('121_2', 'veb', LIMIT_SINGLE, f_and( 	has_medal ('121_1'),
								f_plus(	f_plus(	object_stat ('vehicles', 'roadKills', VEHICLE_TYPE_as_hov_light),
										object_stat ('vehicles', 'roadKills', VEHICLE_TYPE_heavy_ifv),
										object_stat ('vehicles', 'roadKills', VEHICLE_TYPE_TRANSP_AIR), 5),
								f_plus(	f_plus(	global_stat ('vtp-1'),
										global_stat ('vtp-6')),
										global_stat ('vtp-4'), 90000)), 500),

			('121_3', 'veb', LIMIT_SINGLE, f_and( 	has_medal ('121_2'),
								f_plus(	f_plus(	object_stat ('vehicles', 'roadKills', VEHICLE_TYPE_as_hov_light),
										object_stat ('vehicles', 'roadKills', VEHICLE_TYPE_heavy_ifv),
										object_stat ('vehicles', 'roadKills', VEHICLE_TYPE_TRANSP_AIR), 12),
								f_plus(	f_plus(	global_stat ('vtp-1'),
